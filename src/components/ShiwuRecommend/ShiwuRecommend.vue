<template>
  <div class="recommend-wrap">
    <div class="container">
      ...
      <a href="/" class="minor-item" v-for="(recom,index) in recommend.recommends" :key="index">
        <div class="minor-topic">
          <div class="author">
            <div class="avatar">
              <img :src="recom.avatar">
            </div>
            <div class="nickname">{{recom.nickname}}</div>
          </div>
          <div class="line1">{{recom.title}}</div>
          <div class="line2">{{recom.subtitle}}</div>
        </div>
        <div class="minor-pic">
          <div class="img-container" :style="{backgroundImage:'url('+recom.picUrl+')'}">
            <div class="tag">
              <div class="content">{{recom.typeName}}</div>
            </div>
          </div>
        </div>
      </a>
